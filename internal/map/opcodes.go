...
func (op OpCode) String() string {
	...
	case OP_MAKE_FN: return "OP_MAKE_FN"
	case OP_SELECT: return "OP_SELECT"
	case OP_MATCH_STRUCT: return "OP_MATCH_STRUCT"
	...
	case OP_SELF: return "OP_SELF"
	case OP_LOAD_PARENT: return "OP_LOAD_PARENT"
	case OP_MAKE_MAP: return "OP_MAKE_MAP"
	case OP_POST: return "OP_POST"
	case OP_INJECT: return "OP_INJECT"
	...
	case OP_DIV_FLOAT: return "OP_DIV_FLOAT"
	case OP_DIV_INT: return "OP_DIV_INT"
	case OP_MOD: return "OP_MOD"
	case OP_SCI_NOT: return "OP_SCI_NOT"
	case OP_ROOT: return "OP_ROOT"
	case OP_DEV: return "OP_DEV"
	...
	case OP_HAS_SUBFIELD: return "OP_HAS_SUBFIELD"
	case OP_NOT_HAS_SUB: return "OP_NOT_HAS_SUB"
	case OP_HAS_FIELD: return "OP_HAS_FIELD"
	case OP_NOT_HAS_FLD: return "OP_NOT_HAS_FLD"
	case OP_TEMP_SUBFIELD: return "OP_TEMP_SUBFIELD"
	case OP_CONCAT: return "OP_CONCAT"
	case OP_ACCESS_NESTED: return "OP_ACCESS_NESTED"
	...
	case OP_COALESCE: return "OP_COALESCE"
	case OP_MATCH_CONS: return "OP_MATCH_CONS"
	case OP_MATCH_PEEK: return "OP_MATCH_PEEK"
	case OP_APPEND: return "OP_APPEND"
	case OP_UNSHIFT: return "OP_UNSHIFT"
	case OP_LENGTH: return "OP_LENGTH"
	case OP_IS_EMPTY: return "OP_IS_EMPTY"
	case OP_ALL_SUB: return "OP_ALL_SUB"
	case OP_ALL_FIELDS: return "OP_ALL_FIELDS"
	case OP_ALL_POS: return "OP_ALL_POS"
	case OP_FREEZE: return "OP_FREEZE"
	case OP_COPY: return "OP_COPY"
	case OP_COERCE_DATE: return "OP_COERCE_DATE"
	case OP_GET_PARAMS: return "OP_GET_PARAMS"
	case OP_GET_CTOR: return "OP_GET_CTOR"
	case OP_GET_BASE: return "OP_GET_BASE"
	case OP_COERCE_NUM: return "OP_COERCE_NUM"
	case OP_NUM_NEG: return "OP_NUM_NEG"
	case OP_COERCE_BOOL: return "OP_COERCE_BOOL"
