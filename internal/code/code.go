...
func (c Value) WHAT() string {
	return fmt.Sprint("code.Value[", c.id, "]")
}
...
func (c Local) WHAT() string {
	return fmt.Sprint("code.Local[", c.id, "]")
}
...
func (c Inner) WHAT() string {
	return fmt.Sprint("code.Inner[", c.id, "]")
}
...
func (c Under) WHAT() string {
	return fmt.Sprint("code.Under[", c.id, "]")
}
...
func (c Outer) WHAT() string {
	return fmt.Sprint("code.Outer[", c.id, "]")
}
...
func (c Event) WHAT() string {
	return fmt.Sprint("code.Event[", c.id, "]")
}
...
func (c Reply) WHAT() string {
	return fmt.Sprint("code.Reply[", c.id, "]")
}
